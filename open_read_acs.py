...
# function per aprire la porta dell'acs (port='COM11', baudrate=115200).
# dev file is hard-coded : 'C:\Users\gos_situ\ACS-Ve\ACS0424.DEV'
def open_port():

    # apertura porta
    acs=serial.Serial(port='COM7', baudrate=115200, bytesize=8, parity='N', stopbits=1, timeout=1, xonxoff=False, rtscts=False, dsrdtr=False)
    ...
    dev=ACSParser(r'C:\Users\ridopoco\ACS-0426\ACS426.dev')
